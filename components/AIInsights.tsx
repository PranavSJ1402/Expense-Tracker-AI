    ...
    return (
      <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
          <div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-cyan-500 via-green-500 to-sky-500 rounded-xl flex items-center justify-center shadow-lg'>
          ...
          <div className='flex items-center gap-1 sm:gap-2'>
            <div className='w-5 h-5 sm:w-6 sm:h-6 border-2 border-cyan-500/30 border-t-cyan-500 rounded-full animate-spin'></div>
            <span className='text-xs sm:text-sm text-cyan-600 dark:text-cyan-400 font-medium hidden sm:block'>
              Analyzing...
            </span>
          </div>
        </div>
    ...
    <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
      <div className='flex items-center justify-between mb-4 sm:mb-6'>
        <div className='flex items-center gap-2 sm:gap-3'>
          <div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-cyan-500 via-blue-500 to-sky-500 rounded-xl flex items-center justify-center shadow-lg'>
            <span className='text-white text-sm sm:text-lg'>🤖</span>
          </div>
          <div>
            <h3 className='text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100'>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
          ...
          <button
            ...
            className='w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-r from-cyan-600 via-blue-500 to-sky-500 hover:from-cyan-700 hover:via-blue-600 hover:to-sky-600 text-white rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200'
            disabled={isLoading}
          >
                  ...
                  {currentAnswer && (
                    <div className='mt-3 p-3 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600'>
                      <div className='flex items-start gap-2'>
                        <div className='w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-br from-cyan-500 via-green-500 to-sky-500 rounded-lg flex items-center justify-center flex-shrink-0'>
      ...
      <div className='mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700'>
        <div className='flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0'>
          <div className='flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400'>
            <div className='w-5 h-5 sm:w-6 sm:h-6 bg-cyan-50 dark:bg-cyan-900/30 rounded-lg flex items-center justify-center'>
              <span className='text-sm'>🧠</span>
            </div>
