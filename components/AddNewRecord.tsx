...
const AddRecord = () => {
  ...
  const [amount, setAmount] = useState(1); // Default value for expense amount
  ...
  return (
    <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-blue-50/50 to-cyan-50/50 dark:from-blue-900/10 dark:to-cyan-900/10 rounded-xl border border-blue-100/50 dark:border-blue-800/50'>
          {/* Expense Description */}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-cyan-50/50 to-blue-50/50 dark:from-cyan-900/10 dark:to-blue-900/10 rounded-xl border border-cyan-100/50 dark:border-cyan-800/50'>
          {/* Category Selection */}
          <div className='space-y-1.5'>
            <label
              htmlFor='category'
          ...
          <div className='space-y-1.5'>
            ...
            >
              ...
              Amount
              <span className='text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline'>
                Enter amount between $1 and $1,000
              </span>
            </label>
            <div className='relative'>
        ...
        <button
          type='submit'
          className='w-full relative overflow-hidden bg-gradient-to-r from-blue-600 via-cyan-500 to-sky-500 hover:from-blue-700 hover:via-cyan-600 hover:to-sky-600 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base'
          disabled={isLoading}
        >
